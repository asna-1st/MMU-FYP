        ...
        <div class="container">
            <div class="row">
                ...
                <!-- <div class="col-md ms-auto">
                    <button type="button" class="btn btn-primary">Gila ka apa</button>
                </div> -->
            </div>
            <div class="row" style="margin-top: 50px;">
                <div class="col-sm-10">
                    <h3>Latest note creation</h3>
                </div>
<!--                 <div class="col-sm-6 py-2">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_array($result)){
                        ...
                        echo '<h5 class="card-title textoverfloe">'.$row["note_title"].'</h5>';
                        echo '<p class="card-text textoverflow">d'.$row["note_content"].'</p>';
